...
<div style="margin: 2.5rem auto; max-width: 650px; padding: 30px; background: #ffffff; border-radius: 16px; box-shadow: 0 10px 40px -10px rgba(53,78,107,0.15); border: 1px solid rgba(53,78,107,0.08); text-align: center; position: relative; overflow: hidden;">
  ...
  <h3 style="color: #354e6b; font-weight: 700; margin-top: 10px; margin-bottom: 15px; font-size: 1.4rem;">
    Děkujeme za účast na terénním výzkumu 2026!
  </h3>
  <p style="color: #6c757d; margin-bottom: 25px; font-size: 1.05rem;">
    Vaše zpětná vazba je pro nás velmi cenná. Prosíme o vyplnění krátkého dotazníku po skončení výzkumu.
  </p>
  <a href="https://docs.google.com/forms/d/e/1FAIpQLSeDMPmWGWXdw2o4IQQNMlXaZvmyRlcNozv5gYjtuR69gcfO0w/viewform?usp=header" target="_blank" class="btn btn-primary" style="background-color: #354e6b; border-color: #354e6b; padding: 12px 35px; font-size: 1.1rem; border-radius: 50px; box-shadow: 0 4px 15px rgba(53,78,107,0.3); font-weight: 600;">
    <i class="bi bi-pencil-square" style="margin-right: 8px;"></i> Vyplnit dotazník
  </a>
</div>
...
## Opylovačské setkání – III. ročník {#setkani}

Za mnoho let se na sezónním výzkumu opylovačů na Handrkově vystřídalo hodně lidí a teď bychom chtěli znovu shrnout dosavadní výsledky a udělat výhled do budoucna.

### 📅 Kdy a kde

- 🗓️ **Datum**: 21. a 22. března 2026
- 🕙 **Sobota od**: 10:00 (konec druhý den do 14:00)
- 📍 **Místnost**: [B121, budova Viničná 7 (1. patro)](https://natur.cuni.cz/kontakty/mapy/mapa-budov/budova-vinicna-7/budova-vinicna-7-1-patro)

### 🗓️ Program

- **Dopoledne & odpoledne**: Diskuse o diverzitě opylovačů na louce, dosavadních výsledcích pokusů a co nám říkají o fungování světa kolem nás
- **Večer**: Hraní, povídání a 🍕 pizza
- **Přespání**: Pro zájemce je možné zajistit přespání na fakultě

### 📝 Přihlášení

Prosíme, vyplňte přihlašovací formulář, abychom měli přehled o účasti.

<div style="text-align: center; margin: 1em 0;">
  <a href="https://forms.gle/KH4h1MFDTWYgon4a7" class="btn btn-primary" role="button" target="_blank">
    Vyplnit formulář účasti
  </a>
</div>

### Plakát setkání 2024

![Plakát opylovačského setkání 2024](images/Plakat_setkani_opyl2024(2).png){width=70% fig-align="center" .border .rounded .shadow-sm}
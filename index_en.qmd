...
document.addEventListener('DOMContentLoaded', function() {
    // Mapping of Czech links (from _quarto.yml) to English text and new href
    const navReplacements = {
        'index.html': { text: 'Pollinators of Handrkov', href: 'index_en.html' },
        'index.html#mise': { text: 'Mission & Goals', href: 'index_en.html#mission' },
        'index.html#prakticke-informace': { text: 'Practical Info', href: 'index_en.html#practical-info' },
        'index.html#pridejse': { text: 'Join Us!', href: 'index_en.html#join-us' },
        'index.html#kontakt': { text: 'Contact', href: 'index_en.html#contact' }
    };
    ...
    navLinks.forEach(link => {
        ...
        // We check for endsWith because the href might be absolute or relative
        for (const [key, value] of Object.entries(navReplacements)) {
            if (href && href.endsWith(key)) {

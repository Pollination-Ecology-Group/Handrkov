...
<script>
  function translateNavbar() {
    ...
    // Define translations based on the HREF, which is more stable
    // Note: Use relative paths as they appear in the rendered HTML
    const translations = {
      "index.html": { text: "Handrkov Pollinators", href: "index_en.html" },
      "index.html#mise": { text: "Mission and Goals", href: "#mission" },
      "index.html#prakticke-informace": { text: "Practical Information", href: "#practical-info" },
      "index.html#pridejse": { text: "Join Us!", href: "#join-us" },
      "index.html#kontakt": { text: "Contact", href: "#contact" },
      // Fallback for cases where index.html might be omitted or absolute
      "/index.html": { text: "Handrkov Pollinators", href: "index_en.html" },
      "/index.html#mise": { text: "Mission and Goals", href: "#mission" },
      "/index.html#prakticke-informace": { text: "Practical Information", href: "#practical-info" },
      "/index.html#pridejse": { text: "Join Us!", href: "#join-us" },
    ...
    navLinks.forEach(link => {
      ...
      // Check if we have a translation for this href
      if (href && translations[href]) {
        link.textContent = translations[href].text;
        link.setAttribute('href', translations[href].href);
      } else {
        // Also try matching just the hash if it's an internal link on the original page
        // (though in this context, they likely point to index.html#...)
      }
    });

    // Handle the brand link separately
    const brand = document.querySelector('.navbar-brand');
    if (brand) {
        brand.setAttribute('href', 'index_en.html');
        const title = brand.querySelector('.navbar-title');
        // Check if title exists and matches the Czech title to translate
        if (title && (title.textContent.trim() === "Opylovači Handrkov" || title.textContent.trim() === "Handrkov Pollinators")) {
